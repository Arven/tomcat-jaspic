...
public class BasicAuthConfigProvider implements AuthConfigProvider {
    ...
    public BasicAuthConfigProvider() {
    }
     ...
     * @param factory
     */
    public BasicAuthConfigProvider(Map<String, String> properties,
    ...
    public ServerAuthConfig getServerAuthConfig(String layer, String appContext, CallbackHandler handler) throws AuthException {
        return new BasicServerAuthConfig(layer, appContext, (handler == null ? createDefaultCallbackHandler() : handler), providerProperties);
    }
